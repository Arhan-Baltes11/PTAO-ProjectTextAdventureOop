...
public class JSONParserConfiguration extends ParserConfiguration {
     ...
     * when parsing a map into JSONObject or parsing a {@link java.util.Collection}
     * instance into
     * JSONArray. The default max nesting depth is 512, which means the parser will
     ...
     * If set to false, the parser will throw a JSONException when meeting a
     * duplicate key.
     * Or the duplicate key's value will be overwritten.
     *
     * @param overwriteDuplicateKey defines should the parser overwrite duplicate
     *                              keys.
     * @return The existing configuration will not be modified. A new configuration
     *         is returned.
     */
    ...
    /**
     * The parser's behavior when meeting duplicate keys, controls whether the
     * parser should
