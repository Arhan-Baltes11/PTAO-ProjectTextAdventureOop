...
public class JSONObject {
    ...
    /**
     * Construct a JSONObject from a JSONTokener with custom json parse
     * configurations.
     *
     * @param x
     *                                A JSONTokener object containing the source
     *                                string.
    ...
    /**
     * Construct a JSONObject from a source JSON text string with custom json parse
     * configurations.
