...
public class JSONPointer {
    ...
    public static class Builder {
         ...
         * pointers, the
         * argument of this method MUST NOT be escaped. If you want to query the
         * property called
         * {@code "a~b"} then you should simply pass the {@code "a~b"} string as-is,
         * there is no
    ...
    /**
     * Constructs a new JSONPointer instance with the provided list of reference
     * tokens.
     *
     * @param refTokens A list of strings representing the reference tokens for the
     *                  JSON Pointer.
     ...
     * {@code document}
     * is usually a {@link JSONObject} or a {@link JSONArray} instance, but the
     * empty
     * JSON Pointer ({@code ""}) can be evaluated on any JSON values and in such
     * case the
